export function SiteFooter() {
  return (
    <footer className="flex min-h-[7.5rem] w-full items-center justify-between bg-[#52494b] px-8 py-12 text-[rgba(255,255,255,0.8)] max-[767px]:flex-col max-[767px]:items-start max-[767px]:gap-6 max-[767px]:px-6 max-[767px]:py-9">
