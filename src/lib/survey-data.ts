...
export const SURVEY_PARTS: readonly SurveyPart[] = [
  ...
  },
  {
    id: "part-3",
    routeKey: "part-3",
    title: "Part 3. MSBF 행동 프로파일",
    subtitle: "MSBF 행동 프로파일",
    questionCount: 16,
    questionRange: [65, 80],
  },
];
...
export const SURVEY_QUESTIONS: readonly SurveyQuestion[] = [
  ...
  question(65, "mission", "현재 직업/사업에서 수입을 늘리기 위해 적극적으로 노력하고 있다.", "게으른 자는 마음으로 원하여도 얻지 못하나 부지런한 자의 마음은 풍족함을 얻느니라 (잠 13:4)"),
  question(66, "mission", "새로운 수입원이나 부업을 개발하려는 노력을 하고 있다.", "너는 아침에 씨를 뿌리고 저녁에도 손을 놓지 말라 이것이 잘 될는지, 저것이 잘 될는지, 혹 둘이 다 잘 될는지 알지 못함이니라 (전 11:6)"),
  question(67, "mission", "자기계발을 통해 경제적 가치를 높이고 있다.", "네가 자기의 일에 능숙한 사람을 보았느냐 이러한 사람은 왕 앞에 설 것이요 천한 자 앞에 서지 아니하리라 (잠 22:29)"),
  question(68, "mission", "하나님이 주신 달란트를 활용하여 경제활동을 하고 있다.", "다섯 달란트 받았던 자는 다섯 달란트를 더 가지고 와서 이르되 주인이여 내게 다섯 달란트를 주셨는데 보소서 내가 또 다섯 달란트를 남겼나이다 (마 25:20)"),
  question(69, "stewardship", "꼭 필요한 것과 원하는 것을 구분하여 소비한다.", "나는 비천에 처할 줄도 알고 풍부에 처할 줄도 알아 모든 일 곧 배부름과 배고픔과 풍부와 궁핍에도 처할 줄 아는 일체의 비결을 배웠노라 (빌 4:12)"),
  question(70, "stewardship", "가계부 등을 통해 지출을 체계적으로 관리한다.", "네 양 떼의 형편을 부지런히 살피며 네 소 떼에게 마음을 두라 (잠 27:23)"),
  question(71, "stewardship", "할인이나 프로모션에 흔들리지 않고 계획대로 소비한다.", "부지런한 자의 경영은 풍부함에 이를 것이나 조급한 자는 궁핍함에 이를 따름이니라 (잠 21:5)"),
  question(72, "stewardship", "가족과 소비 기준에 대해 합의하고 실천하고 있다.", "두 사람이 뜻이 같지 않은데 어찌 동행하겠으며 (암 3:3)"),
  question(73, "building", "매월 정기적으로 저축하는 습관이 있다.", "지혜 있는 자의 집에는 귀한 보배와 기름이 있으나 미련한 자는 이것을 다 삼켜 버리느니라 (잠 21:20)"),
  question(74, "building", "투자에 대해 공부하고 신중하게 결정한다.", "명철한 자의 마음은 지식을 얻고 지혜로운 자의 귀는 지식을 구하느니라 (잠 18:15)"),
  question(75, "building", "분산투자 등 위험관리를 실천하고 있다.", "일곱에게나 여덟에게 나눠 줄지어다 무슨 재앙이 땅에 임할는지 네가 알지 못함이니라 (전 11:2)"),
  question(76, "building", "은퇴 후를 위한 장기 투자 계획이 있다.", "게으른 자여 개미에게 가서 그가 하는 것을 보고 지혜를 얻으라, 개미는 두령도 없고 감독자도 없고 통치자도 없으되, 먹을 것을 여름 동안에 예비하며 추수 때에 양식을 모으느니라 (잠 6:6-8)"),
  question(77, "flowing", "십일조를 기쁜 마음으로 성실히 드리고 있다.", "만군의 여호와가 이르노라 너희의 온전한 십일조를 창고에 들여 나의 집에 양식이 있게 하고 그것으로 나를 시험하여 내가 하늘 문을 열고 너희에게 복을 쌓을 곳이 없도록 붓지 아니하나 보라 (말 3:10)"),
  question(78, "flowing", "감사헌금, 선교헌금 등을 자발적으로 드리고 있다.", "각각 그 마음에 정한 대로 할 것이요 인색함으로나 억지로 하지 말지니 하나님은 즐겨 내는 자를 사랑하시느니라 (고후 9:7)"),
  question(79, "flowing", "이웃의 필요를 보면 물질적으로 돕고 있다.", "만일 형제나 자매가 헐벗고 일용할 양식이 없는데, 너희 중에 누구든지 그에게 이르되 평안히 가라, 덥게 하라, 배부르게 하라 하며 그 몸에 쓸 것을 주지 아니하면 무슨 유익이 있으리요 (약 2:15-16)"),
  question(80, "flowing", "나눔을 통해 기쁨과 감사를 경험하고 있다.", "범사에 여러분에게 모본을 보여준 바와 같이 수고하여 약한 사람들을 돕고 또 주 예수께서 친히 말씀하신 바 주는 것이 받는 것보다 복이 있다 하심을 기억하여야 할지니라 (행 20:35)"),
];
