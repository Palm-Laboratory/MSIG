...
export default function InfoPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#fff7f5]">
      ...
      <section
        className="relative flex min-h-[720px] flex-col items-center overflow-hidden bg-[#615557] bg-cover bg-center bg-no-repeat px-[60px] py-[115px] text-[#fff5f0] [@media(min-height:760px)]:min-h-[100svh] [@media(min-height:980px)]:min-h-[900px] max-lg:px-6 max-lg:py-35"
        id="process"
        style={{ backgroundImage: 'url("https://www.figma.com/api/mcp/asset/68db41fe-e8a4-4ad5-9cce-e6a0e6b29ec8")' }}
      />

      <section className="relative flex min-h-[720px] flex-col items-center gap-[60px] overflow-hidden bg-[#52494b] px-[60px] py-[100px] text-[#fff7f5] [@media(min-height:760px)]:min-h-[100svh] [@media(min-height:980px)]:min-h-[900px] max-lg:px-6 max-lg:py-35" id="archetypes">
